...
ax[0, 0].scatter(T2, E80, label = "N = 80", color = "g", s = 10)
ax[0, 0].scatter(T2, E100, label = "N = 100", color = "orange", s = 10)
ax[0, 0].legend(loc = 0)
...
ax[1, 0].scatter(T2, M80, label = "N = 80", color = "g", s = 10)
ax[1, 0].scatter(T2, M100, label = "N = 100", color = "orange", s = 10)
ax[1, 0].legend(loc = 0)
...
ax[0, 1].scatter(T2, C_v80, label = "N = 80", color = "g", s = 10)
ax[0, 1].scatter(T2, C_v100, label = "N = 100", color = "orange", s = 10)
ax[0, 1].legend(loc = 0)
...
ax[1, 1].scatter(T2, Chi80, label = "N = 80", color = "g", s = 10)
ax[1, 1].scatter(T2, Chi100, label = "N = 100", color = "orange", s = 10)
ax[1, 1].legend(loc = 0)
