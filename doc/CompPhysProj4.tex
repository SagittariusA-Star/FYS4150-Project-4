...
\begin{deluxetable}{lcccc}
	...
	\enddata
\end{deluxetable}
To verify this the model was then used to calculate the energy $E$ and absolute
magnetisation $\vert M \vert$ both as functions of the
...
flips per Monte Carlo cycle. By studying the histogram, as shown in
...
different compiler flags. This is tabulated in Table \ref
