...
given by 
\begin{align}\label{eq:analyticalmag}
...
\begin{deluxetable}{lcccc}
	...
	\enddata
\end{deluxetable}
The model was then used to calculate the energy $E$, absolute magnetisation
$\vert M \vert$ and heat capacity $C_v$ all as functions of the temperatue $T$.
The number of flips was also counted for these calculations. 
capacity
\begin{figure*}
